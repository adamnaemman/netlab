...
export const units = [
    {
        ...
        levels: [
            ...
            },
            {
                id: '1-TEST',
                name: '🧪 Unit 1 Test',
                description: 'Practical Test - No Hints!',
                difficulty: 'Test',
                totalXP: 150,
                isTest: true,
                scenario: "🧪 PRACTICAL TEST: Configure a router from scratch. No hints - prove your knowledge!",
                steps: [
                    { id: 'enable', description: 'Enter Privileged EXEC Mode', device: 'router', command: 'enable', hint: '', xp: 15 },
                    { id: 'conf-t', description: 'Enter Global Configuration Mode', device: 'router', command: 'conf t', hint: '', xp: 15 },
                    { id: 'hostname', description: 'Set hostname to "CoreRouter"', device: 'router', command: 'hostname CoreRouter', hint: '', xp: 25 },
                    { id: 'interface', description: 'Select GigabitEthernet 0/0', device: 'router', command: 'int g0/0', hint: '', xp: 20 },
                    { id: 'ip-address', description: 'Configure IP: 10.0.0.1 with mask 255.255.255.0', device: 'router', command: 'ip address 10.0.0.1 255.255.255.0', hint: '', xp: 35 },
                    { id: 'no-shutdown', description: 'Activate the interface', device: 'router', command: 'no shutdown', hint: '', xp: 20 },
                    { id: 'end', description: 'Return to Privileged EXEC Mode', device: 'router', command: 'end', hint: '', xp: 20 },
                ],
            },
        ],
    },
    {
        ...
        levels: [
            ...
            },
            {
                ...
                totalXP: 200,
                isTest: true,
                scenario: "🧪 PRACTICAL TEST: Configure VLANs and segmentation from scratch. No hints - prove your networking skills!",
                steps: [
                    { id: 'enable', description: 'Enter Privileged Mode', device: 'switch', command: 'enable', hint: '', xp: 10 },
                    { id: 'conf-t', description: 'Enter Global Configuration Mode', device: 'switch', command: 'conf t', hint: '', xp: 10 },
                    { id: 'hostname', description: 'Set hostname to "DistSwitch"', device: 'switch', command: 'hostname DistSwitch', hint: '', xp: 15 },
                    { id: 'vlan10', description: 'Create VLAN 10', device: 'switch', command: 'vlan 10', hint: '', xp: 15 },
                    { id: 'name10', description: 'Name this VLAN "Management"', device: 'switch', command: 'name Management', hint: '', xp: 15 },
                    { id: 'vlan20', description: 'Create VLAN 20', device: 'switch', command: 'vlan 20', hint: '', xp: 15 },
                    { id: 'name20', description: 'Name this VLAN "Production"', device: 'switch', command: 'name Production', hint: '', xp: 15 },
                    { id: 'interface-f1', description: 'Select FastEthernet 0/1', device: 'switch', command: 'int f0/1', hint: '', xp: 15 },
                    { id: 'mode-access', description: 'Configure as access port', device: 'switch', command: 'switchport mode access', hint: '', xp: 20 },
                    { id: 'access-vlan10', description: 'Assign to VLAN 10', device: 'switch', command: 'switchport access vlan 10', hint: '', xp: 25 },
                    { id: 'interface-g1', description: 'Select GigabitEthernet 0/1', device: 'switch', command: 'int g0/1', hint: '', xp: 15 },
                    { id: 'trunk', description: 'Configure as trunk port', device: 'switch', command: 'switchport mode trunk', hint: '', xp: 30 },
                ],
            },
        ],
    },
